...
CFG = {
    ...
    "watermark": {
        # 把整册重复出现的水印 Form XObject 调用剔掉，另存一份干净 PDF 再送 MinerU。
        # 只有覆盖率超过 min_page_coverage 的可选内容组（/OC）或命中 form_names /
        # image_sizes 的对象才会被剔除；判错风险由 min_page_coverage 兜底。
        "enabled": True,
        "form_names": [],
        "image_sizes": [],
    ...
    "mineru": {
        ...
        # server_url 是 vlm-http-client 后端的推理服务地址，不发的话服务端会去读
    ...
    "vlm_pool": {
        ...
        "providers": [
            ...
            },
            {
                ...
                "url": "http://10.107.231.26:8002/v1/chat/completions",
                "model": "Qwen3.8-27B",
                "api_key": "local-pool-key",
                "stream": False,
                "temperature": 0.6,
            ...
            },
            {
                ...
                "url": "http://10.107.231.26:8003/v1/chat/completions",
                "model": "Qwen3.8-27B",
                "api_key": "local-pool-key",
                "stream": False,
                "temperature": 0.6,
            ...
            {
                # 暂停
                "name": "Qwen3.8-27B-26-8004",
                "url": "http://10.107.231.26:8004/v1/chat/completions",
                "model": "Qwen3.8-27B",
                "api_key": "local-pool-key",
                "enabled": False,
                "stream": False,
            ...
            },
            {
                ...
                "url": "http://10.107.234.43:8002/v1/chat/completions",
                "model": "Qwen3.8-27B",
                "api_key": "local-pool-key",
                "stream": False,
                "temperature": 0.6,
            ...
            },
            {
                ...
                "url": "http://10.107.234.43:8003/v1/chat/completions",
                "model": "Qwen3.8-27B",
                "api_key": "local-pool-key",
                "stream": False,
                "temperature": 0.6,
            ...
            },
            {
                ...
                "url": "http://10.107.234.43:8004/v1/chat/completions",
                "model": "Qwen3.8-27B",
                "api_key": "local-pool-key",
                "stream": False,
                "temperature": 0.6,
            ...
            },
            {
                ...
                "url": "http://10.107.238.7:8002/v1/chat/completions",
                "model": "Qwen3.8-27B",
                "api_key": "local-pool-key",
                "stream": False,
                "temperature": 0.6,
            ...
            },
            {
                ...
                "url": "http://10.107.238.7:8003/v1/chat/completions",
                "model": "Qwen3.8-27B",
                "api_key": "local-pool-key",
                "stream": False,
                "temperature": 0.6,
            ...
            },
            {
                ...
                "url": "http://10.107.238.7:8004/v1/chat/completions",
                "model": "Qwen3.8-27B",
                "api_key": "local-pool-key",
                "stream": False,
                "temperature": 0.6,
            ...
            },
            {
                ...
                "url": "http://10.107.226.31:8002/v1/chat/completions",
                "model": "Qwen3.8-27B",
                "api_key": "local-pool-key",
                "stream": False,
                "temperature": 0.6,
            ...
            },
            {
                ...
                "url": "http://10.107.226.31:8003/v1/chat/completions",
                "model": "Qwen3.8-27B",
                "api_key": "local-pool-key",
                "stream": False,
                "temperature": 0.6,
            ...
            },
            {
                ...
                "url": "http://10.107.226.31:8004/v1/chat/completions",
                "model": "Qwen3.8-27B",
                "api_key": "local-pool-key",
                "stream": False,
                "temperature": 0.6,
